  ...
  const downloadReceipt = async () => {
    ...
    try {
      const receiptText = `
        ...
        Processed by Admin for ${order.user.email}
        ======================
      `;
    ...
    <div className="min-h-screen bg-gray-50 py-8" style={{ fontFamily: '"Plus Jakarta Sans", "Noto Sans", sans-serif' }}>
      <div className="max-w-2xl mx-auto px-4">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-800 mb-2">Payment Processed Successfully!</h1>
          <p className="text-gray-600">The order has been confirmed for {order?.user.email || 'the customer'}.</p>
        </div>
        ...
        {order ? (
          ...
          <div className="text-center py-12 bg-white rounded-xl shadow-sm">
            ...
            <p className="text-gray-400 text-sm mb-4">We couldn't find the order details for this payment.</p>
          </div>
        )}
        ...
        {order && (
          <div className="mt-8 bg-blue-50 border border-blue-200 rounded-lg p-6">
            ...
            <div className="space-y-2 text-sm text-blue-700">
              <p>• The customer ({order.user.email}) has been notified via email</p>
              <p>• The order will be processed within 24 hours</p>
              <p>• Monitor order status in the admin dashboard</p>
              <p>• Contact support if there are any issues</p>
            </div>
          </div>
        )}
      </div>
